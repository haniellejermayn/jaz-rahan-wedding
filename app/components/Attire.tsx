      ...
      <div className={styles.inner}>
        ...
        <div className={styles.columns}>
          <div className={`${styles.col} reveal-left delay-2`}>
            ...
            >
              <path
                d="M20,4 L26,12 L30,12 L30,20 L26,20 L26,36 L14,36 L14,20 L10,20 L10,12 L14,12 Z"
                fill="none"
                stroke="currentColor"
                strokeWidth="0.9"
            ...
            <p className={styles.colBody}>
              <strong>Classic or modern Barong Tagalog</strong> with black
              pants.
            </p>
          </div>
          ...
          <div className={`${styles.col} reveal-right delay-2`}>
            ...
            >
              <path
                d="M20,4 L14,14 L8,38 L32,38 L26,14 L20,4 Z"
                fill="none"
                stroke="currentColor"
                strokeWidth="0.9"
                strokeLinejoin="round"
        ...
        <p className={`${styles.footnote} reveal delay-3`}>
          <em>
            Please avoid wearing white, cream, or ivory &mdash;
            <br />
            those shades belong to the bride.
          </em>
        </p>
      </div>
    </section>
