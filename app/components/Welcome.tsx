...
export default function Welcome() {
  return (
    <section id="welcome" className={styles.section}>
      ...
      <svg className={`${styles.cornerSprig} ${styles.cornerTL}`} viewBox="0 0 160 200" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <svg className={`${styles.cornerSprig} ${styles.cornerBR}`} viewBox="0 0 160 200" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <path d="M0,0 Q40,40 60,90 Q70,130 60,180" stroke="rgba(91,160,47,0.45)" strokeWidth="1.4" fill="none" strokeLinecap="round"/>
        <path d="M30,50 Q10,40 0,50" stroke="#5BA02F" strokeWidth="0.9" fill="none" opacity="0.5"/>
      ...
      <div className={styles.inner}>
        ...
        <h2 className="section-heading reveal delay-1">Welcome,<br/><em className={styles.dear}>dear ones</em></h2>
        <div className="ornament reveal delay-2">✦</div>

        {/* Open-quote ornament */}
        <span className={`${styles.openQuote} reveal delay-2`} aria-hidden="true">&ldquo;</span>
