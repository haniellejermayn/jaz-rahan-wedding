    ...
    <section id="welcome" className={styles.section}>
      <div className={styles.inner}>
        <div className={`${styles.card} reveal`}>
          ...
          >
            <path
              d="M0,0 Q40,40 60,90 Q70,130 60,180"
              stroke="rgba(91,160,47,0.45)"
              strokeWidth="1.4"
              fill="none"
              strokeLinecap="round"
            />
            <path
              d="M30,50 Q10,40 0,50"
              stroke="#5BA02F"
              strokeWidth="0.9"
              fill="none"
              opacity="0.5"
            />
            <path
              d="M0,50 Q14,38 30,50 Q14,62 0,50Z"
              fill="#7DC23D"
              opacity="0.55"
            />
          ...
          <p className={styles.text}>
            With gratitude and joy, we invite you to stand with us as we begin
            this new chapter together.{" "}
            <strong>
              Your company on our wedding day means a great deal to us
            </strong>
